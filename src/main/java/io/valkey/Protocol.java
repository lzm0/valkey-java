...
//  }
  ...
  public static enum Command implements ProtocolCommand {
    ...
    SENTINEL, MODULE, ACL, TOUCH, MEMORY, LOLWUT, COMMAND, RESET, LATENCY, WAITAOF, DEBUG;
  ...
  public static enum Keyword implements Rawable {
    ...
    CHANNELS, NUMPAT, NUMSUB, SHARDCHANNELS, SHARDNUMSUB, NOVALUES, MAXAGE, CAPA, OBJECT, SEGFAULT, MALLOC, GRAPH;
