 ...
 */
public interface AsyncAccessControlLogBinaryCommands {
   ...
   */
  CompletableFuture<byte[]> aclWhoAmIBinary();
   ...
   */
  CompletableFuture<byte[]> aclGenPassBinary();
   ...
   * @return CompletableFuture that completes with a random password
   */
  CompletableFuture<byte[]> aclGenPassBinary(int bits);
   ...
   */
  CompletableFuture<List<byte[]>> aclListBinary();
   ...
   */
  CompletableFuture<List<byte[]>> aclUsersBinary();
   ...
   */
  CompletableFuture<AccessControlUser> aclGetUser(byte[] name);
   ...
   */
  CompletableFuture<String> aclSetUser(byte[] name);
   ...
   * @return CompletableFuture that completes with OK on success
   */
  CompletableFuture<String> aclSetUser(byte[] name, byte[]... rules);
   ...
   */
  CompletableFuture<Long> aclDelUser(byte[]... names);
   ...
   */
  CompletableFuture<List<byte[]>> aclCatBinary();
   ...
   * @return CompletableFuture that completes with the available ACL categories
   */
  CompletableFuture<List<byte[]>> aclCat(byte[] category);
   ...
   */
  CompletableFuture<List<byte[]>> aclLogBinary();
   ...
   * @return CompletableFuture that completes with the list of recent security events
   */
  CompletableFuture<List<byte[]>> aclLogBinary(int limit);
   ...
   */
  CompletableFuture<byte[]> aclDryRunBinary(byte[] username, byte[] command, byte[]... args);
   ...
   * @return CompletableFuture that completes with the simulation result
   */
  CompletableFuture<byte[]> aclDryRunBinary(byte[] username, CommandArguments commandArgs);
} 