...
/**
 * This interface provides async commands for Redis management operations.
 */
public interface AsyncControlCommands extends AsyncAccessControlLogCommands, AsyncClientCommands {
   ...
   */
  CompletableFuture<List<String>> objectHelp();
