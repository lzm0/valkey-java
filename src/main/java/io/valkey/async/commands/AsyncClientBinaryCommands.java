...
/**
 * This interface provides async binary commands for client operations in Redis.
 * The params is byte[]
 */
public interface AsyncClientBinaryCommands {
   ...
   */
  CompletableFuture<String> clientKill(byte[] ipPort);
   ...
   * @return CompletableFuture that completes with the number of clients killed
   */
   ...
   */
  CompletableFuture<byte[]> clientGetnameBinary();
   ...
   */
  CompletableFuture<byte[]> clientListBinary();
   ...
   * @return CompletableFuture that completes with all clients info connected to redis-server
   */
  CompletableFuture<byte[]> clientListBinary(ClientType type);
   ...
   * @return CompletableFuture that completes with all clients info connected to redis-server
   */
  CompletableFuture<byte[]> clientListBinary(long... clientIds);
   ...
   */
  CompletableFuture<byte[]> clientInfoBinary();
   ...
   */
  CompletableFuture<String> clientSetInfo(ClientAttributeOption attr, byte[] value);
   ...
   */
  CompletableFuture<String> clientSetname(byte[] name);
